...
use crate::{
    hal::OptionalOutput,
    msp::msp_displayport::{clear_display, draw_display, set_resolution, write_string_to_screen},
...
use common::msp_protocol::displayport::HDZeroResolution;
...
async fn draw_status_osd(
    ...
    let battery_information = shared_state.get_battery_information();
    let link_stats = shared_state.get_link_state();
